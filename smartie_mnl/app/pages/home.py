...
def show():
    ...
    with col3:
        st.markdown(
            ...
            Generates EPAR heatmaps across multiple RBPs for direct comparison.
            </p>
    ...
    steps = [
        ...
        ("3️⃣  Run the analysis",
         "Click **Run**. Progress appears in real time. The pipeline computes features per gene, "
         "applies the SMARTIE model, and writes all outputs."),
        ("4️⃣  Explore results",
